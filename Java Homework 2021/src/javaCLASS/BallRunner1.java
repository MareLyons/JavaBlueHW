...
public class BallRunner1 extends JPanel implements Runnable {
	...
	public void setup() {
		...
		ball_list.add(new BouncingBall(300, 100, 30, -6, -4, Color.RED));
		ball_list.add(new ColorChangingBall(400, 200, 40, 6, -2, Color.ORANGE));
	...
	public static void main(String[] args) {
		BallRunner1 game = new BallRunner1(); 
		game.start_game();
	}
