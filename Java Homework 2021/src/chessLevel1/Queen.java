...
public class Queen extends Piece{
	...
	public ArrayList<int[]> getMoves(Board board, int r, int c) {
		...
		//for loop to run through the possible moves, moving 1 row right and down 1 column
		for(int i = 1; i < 8; i++) {
			//checks if the move is out of bounds for the columns 
			if(c+i >= 8) {
				break;
			}
			//checks if the move is out of bounds for the rows
			if(r+i >= 8) {
				break;
			}
			//checks if the move is to an empty space		
			...
			//checks if the move is to a space that currently holds a piece on this pieces team
			else if(board.getBoard()[r+i][c+i].getTeam() == board.getBoard()[r][c].getTeam()) {
				//if it does stops the loop, doesnt allow the move
				break;
			}
			//checks if the move is to a space that currently holds a piece on the other team
		...
		//for loop to run through the possible moves, moving 1 row left and up 1 column
		for(int i = 1; i < 8; i++) {
			//checks if the move is out of bounds for the columns 
			if(c-i < 0) {
				break;
		...
		//for loop to run through the possible moves, moving 1 row left and down 1 column
		for(int i = 1; i < 8; i++) {
			//checks if the move is out of bounds for the columns 
			if(c+i >= 8) {
				break;
